...
public static class FileTransferNames
{
    ...
    /// <summary>Builds a timestamped JSON file name from a stem, for example, "Push Day" becomes "Push_Day_20260101_120000.json".</summary>
    public static string JsonFileName(string stem, DateTimeOffset localNow) =>
        $"{stem}_{localNow:yyyyMMdd_HHmmss}.json";

    /// <summary>Builds a timestamped PNG file name from a stem, for example, "Push Day" becomes "Push_Day_20260101_120000.png".</summary>
